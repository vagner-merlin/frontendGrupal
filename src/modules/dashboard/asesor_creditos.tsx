// src/modules/dashboard/asesor_creditos.tsx
import React from "react";
import { useNavigate } from "react-router-dom";
import { useAuth } from "../auth/service";
import "../../styles/dashboard.css";

const DashboardAsesorCreditos: React.FC = () => {
    ...
    <div className="dashboard-container">
      ...
      <div className="dashboard-content">
        <div className="welcome-section">
          ...
          <p className="subtitle">Panel de Asesor de Créditos</p>
          
          <div className="empty-state">
            <div className="empty-icon">📊</div>
            <h3>Dashboard en Construcción</h3>
            <p>Aquí verás las métricas y herramientas específicas para tu rol como Asesor de Créditos.</p>
          </div>
        </div>
...
export default DashboardAsesorCreditos;
