// src/modules/dashboard/gestion_financiera.tsx
import React from "react";
import { useAuth } from "../auth/service";
import "../../styles/dashboard.css";

const DashboardGestionFinanciera: React.FC = () => {
  const { user } = useAuth();
    ...
    <div className="dashboard-container">
      ...
      <div className="dashboard-content">
        <div className="welcome-section">
          ...
          <p className="subtitle">Panel de Gestión Financiera</p>
          
          <div className="empty-state">
            <div className="empty-icon">💹</div>
            <h3>Dashboard en Construcción</h3>
            <p>Aquí verás las métricas financieras, contables y de tesorería.</p>
          </div>
        </div>
...
export default DashboardGestionFinanciera;
